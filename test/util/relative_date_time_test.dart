...
void main() {
  group('relativeFromNow', () {
    test('Seconds to minutes threshold', () {
      ...
      expect(a.relativeFromNow(), equals('a few seconds ago'),
          reason: 'Below default seconds to minutes threshold');

      a = a.subtract(Duration(seconds: 1));
      expect(a.relativeFromNow(), equals('a minute ago'),
    ...
    test('Minutes to hours threshold', () {
      ...
      expect(a.relativeFromNow(), equals('44 minutes ago'),
          reason: 'Below default minute to hour threshold');

      a = a.subtract(Duration(minutes: 1));
      expect(a.relativeFromNow(), equals('an hour ago'),
    ...
    test('Hours to days threshold', () {
      ...
      expect(a.relativeFromNow(), equals('21 hours ago'),
          reason: 'Below default hours to day threshold');

      a = a.subtract(Duration(hours: 1));
      expect(a.relativeFromNow(), equals('a day ago'),
    ...
    test('Days to month threshold', () {
      ...
      expect(a.relativeDateFrom(now), equals('25 days ago'),
          reason: 'Below default days to month (singular) threshold');

      a = a.subtract(Duration(days: 1));
      expect(a.relativeDateFrom(now), equals('a month ago'),
    ...
    test('months to year threshold', () {
      ...
      a = DateTime(a.year, a.month - 10, a.day, a.hour, a.minute, a.second,
          a.millisecond, a.microsecond);
      expect(a.relativeFromNow(), equals('10 months ago'),
          reason: 'Below default days to years threshold');

      a = DateTime(a.year, a.month - 1, a.day, a.hour, a.minute, a.second,
          a.millisecond, a.microsecond);
      expect(a.relativeFromNow(), equals('a year ago'),
    ...
    test('years', () {
      ...
      a = DateTime(a.year - 1, a.month, a.day, a.hour, a.minute, a.second,
          a.millisecond, a.microsecond);
      expect(a.relativeFromNow(), equals('a year ago'));

      a = DateTime(a.year - 1, a.month, a.day, a.hour, a.minute, a.second,
          a.millisecond, a.microsecond);
      expect(a.relativeFromNow(), equals('2 years ago'));

      a = DateTime(a.year - 10, a.month - 1, a.day, a.hour, a.minute, a.second,
          a.millisecond, a.microsecond);
      expect(a.relativeFromNow(), equals('12 years ago'));
    });
  });
  ...
  group('differenceInYears', () {
    ...
    test(
        'not a full year - same month previous year but day short of full year',
        () {
      final a = DateTime(2020, 01, 01);
